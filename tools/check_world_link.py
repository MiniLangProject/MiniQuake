...
"""Verify the check world link compatibility and regression contract."""
...
def doc(root):
    ...
    return {'schema':'MiniQuakeWorldLinkGolden/1','package_id':PACKAGE,'parent_package_id':PARENT,'sources':['world.c','world.h'],'rows':rows(),'reference':{'oracle':ORACLE,'oracle_sha256':sha(root/ORACLE)}}
def cc():
