...
def main():
 ...
 for text,marker in [(screen,'return renderUiContract.overlayOrder'),(status,'return renderUiContract.statusbarScaledXOffset'),(entities,'renderUiContract.viewModelDepthMaximum()')]:
