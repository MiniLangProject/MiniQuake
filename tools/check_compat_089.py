...
"""Verify the check compat 089 compatibility and regression contract."""
...
def main() -> int:
    ...
    errors = []
    golden_path = root / "audit/compat_release_golden.json"
    module_path = root / "src/miniquake/compatibility_matrix.ml"
    test_path = root / "tests/compatibility_release_closure_tests.ml"
