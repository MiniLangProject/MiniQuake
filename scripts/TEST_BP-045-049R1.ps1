...
$DeliveryRevision = "BP-045-049R1"
$Root = Split-Path -Parent $PSScriptRoot
$BuildDirectory = Join-Path $Root "build"
$TraceDirectory = Join-Path $BuildDirectory "bp045-049r1-traces"
...
$TranscriptPath = Join-Path $BuildDirectory ("bp045-049r1-test-{0}.log" -f $Timestamp)
$SummaryPath = Join-Path $BuildDirectory "bp045-049r1-test-summary.json"
$StaticReportPath = Join-Path $BuildDirectory "bp045-049r1-static-verification.json"
$VersionPath = Join-Path $BuildDirectory "bp045-049r1-version.txt"
$BuildChildLogPath = Join-Path $BuildDirectory "bp045-049r1-build-child.log"
$TraceALogPath = Join-Path $BuildDirectory "bp045-049r1-trace-a.log"
$TraceBLogPath = Join-Path $BuildDirectory "bp045-049r1-trace-b.log"
$SnapshotCommandLogPath = Join-Path $BuildDirectory "bp045-049r1-snapshot-command.log"
$TraceComparisonPath = Join-Path $BuildDirectory "bp045-049r1-trace-comparison.json"
$TraceComparisonLogPath = Join-Path $BuildDirectory "bp045-049r1-trace-comparison.log"
$ProtocolVectorReportPath = Join-Path $BuildDirectory "bp045-049r1-protocol15-vectors.json"
$ProtocolVectorLogPath = Join-Path $BuildDirectory "bp045-049r1-protocol15-vectors.log"
$ProtocolCommandReportPath = Join-Path $BuildDirectory "bp045-049r1-protocol15-commands.json"
$ProtocolCommandLogPath = Join-Path $BuildDirectory "bp045-049r1-protocol15-commands.log"
$ProtocolServerDataReportPath = Join-Path $BuildDirectory "bp045-049r1-protocol15-serverdata.json"
$ProtocolServerDataLogPath = Join-Path $BuildDirectory "bp045-049r1-protocol15-serverdata.log"
$ProtocolEventReportPath = Join-Path $BuildDirectory "bp045-049r1-protocol15-events.json"
$ProtocolEventLogPath = Join-Path $BuildDirectory "bp045-049r1-protocol15-events.log"
$ProtocolRuntimeEventReportPath = Join-Path $BuildDirectory "bp045-049r1-protocol15-runtime-events.json"
$ProtocolRuntimeEventLogPath = Join-Path $BuildDirectory "bp045-049r1-protocol15-runtime-events.log"
$ProtocolSignonReportPath = Join-Path $BuildDirectory "bp045-049r1-protocol15-signon.json"
$ProtocolSignonLogPath = Join-Path $BuildDirectory "bp045-049r1-protocol15-signon.log"
$ProtocolDeliveryReportPath = Join-Path $BuildDirectory "bp045-049r1-protocol15-delivery.json"
$ProtocolDeliveryLogPath = Join-Path $BuildDirectory "bp045-049r1-protocol15-delivery.log"
$ProtocolDatagramReportPath = Join-Path $BuildDirectory "bp045-049r1-protocol15-datagram.json"
$ProtocolDatagramLogPath = Join-Path $BuildDirectory "bp045-049r1-protocol15-datagram.log"
$ProtocolDemoReportPath = Join-Path $BuildDirectory "bp045-049r1-protocol15-demo.json"
$ProtocolDemoLogPath = Join-Path $BuildDirectory "bp045-049r1-protocol15-demo.log"
$ProtocolClosureReportPath = Join-Path $BuildDirectory "bp045-049r1-protocol15-closure.json"
$ProtocolClosureLogPath = Join-Path $BuildDirectory "bp045-049r1-protocol15-closure.log"
$QuakeCProgsReportPath = Join-Path $BuildDirectory "bp045-049r1-quakec-progs.json"
$QuakeCProgsLogPath = Join-Path $BuildDirectory "bp045-049r1-quakec-progs.log"
$QuakeCVMReportPath = Join-Path $BuildDirectory "bp045-049r1-quakec-vm.json"
$QuakeCVMLogPath = Join-Path $BuildDirectory "bp045-049r1-quakec-vm.log"
$QuakeCEdictReportPath = Join-Path $BuildDirectory "bp045-049r1-quakec-edict.json"
$QuakeCEdictLogPath = Join-Path $BuildDirectory "bp045-049r1-quakec-edict.log"
$QuakeCBuiltinReportPath = Join-Path $BuildDirectory "bp045-049r1-quakec-builtins.json"
$QuakeCBuiltinLogPath = Join-Path $BuildDirectory "bp045-049r1-quakec-builtins.log"
$QuakeCClosureReportPath = Join-Path $BuildDirectory "bp045-049r1-quakec-closure.json"
$QuakeCClosureLogPath = Join-Path $BuildDirectory "bp045-049r1-quakec-closure.log"
$WorldHullReportPath = Join-Path $BuildDirectory "bp045-049r1-world-hull.json"
$WorldHullLogPath = Join-Path $BuildDirectory "bp045-049r1-world-hull.log"
$WorldTraceReportPath = Join-Path $BuildDirectory "bp045-049r1-world-trace.json"
$WorldTraceLogPath = Join-Path $BuildDirectory "bp045-049r1-world-trace.log"
$WorldLinkReportPath = Join-Path $BuildDirectory "bp045-049r1-world-link.json"
$WorldLinkLogPath = Join-Path $BuildDirectory "bp045-049r1-world-link.log"
$ServerMoveReportPath = Join-Path $BuildDirectory "bp045-049r1-server-move.json"
$ServerMoveLogPath = Join-Path $BuildDirectory "bp045-049r1-server-move.log"
$ServerPhysicsReportPath = Join-Path $BuildDirectory "bp045-049r1-server-physics.json"
$ServerPhysicsLogPath = Join-Path $BuildDirectory "bp045-049r1-server-physics.log"
$SvUserMovementReportPath = Join-Path $BuildDirectory "bp045-049r1-sv-user-movement.json"
$SvUserMovementLogPath = Join-Path $BuildDirectory "bp045-049r1-sv-user-movement.log"
$ServerUserReportPath = Join-Path $BuildDirectory "bp045-049r1-server-user.json"
$ServerUserLogPath = Join-Path $BuildDirectory "bp045-049r1-server-user.log"
$WorldPhysicsClosureReportPath = Join-Path $BuildDirectory "bp045-049r1-world-physics-closure.json"
$WorldPhysicsClosureLogPath = Join-Path $BuildDirectory "bp045-049r1-world-physics-closure.log"
$HostTimingReportPath = Join-Path $BuildDirectory "bp045-049r1-host-timing.json"
$HostTimingLogPath = Join-Path $BuildDirectory "bp045-049r1-host-timing.log"
$CommandCvarReportPath = Join-Path $BuildDirectory "bp045-049r1-command-cvar.json"
$CommandCvarLogPath = Join-Path $BuildDirectory "bp045-049r1-command-cvar.log"
$DemoLifecycleReportPath = Join-Path $BuildDirectory "bp045-049r1-demo-lifecycle.json"
$DemoLifecycleLogPath = Join-Path $BuildDirectory "bp045-049r1-demo-lifecycle.log"
$SavegameV5ReportPath = Join-Path $BuildDirectory "bp045-049r1-savegame-v5.json"
$SavegameV5LogPath = Join-Path $BuildDirectory "bp045-049r1-savegame-v5.log"
$HostLifecycleClosureReportPath = Join-Path $BuildDirectory "bp045-049r1-host-lifecycle-closure.json"
$HostLifecycleClosureLogPath = Join-Path $BuildDirectory "bp045-049r1-host-lifecycle-closure.log"
$ClientStateRenderReportPath = Join-Path $BuildDirectory "bp045-049r1-client-state-render.json"
$ClientStateRenderLogPath = Join-Path $BuildDirectory "bp045-049r1-client-state-render.log"
$ViewStateReportPath = Join-Path $BuildDirectory "bp045-049r1-view-state.json"
$ViewStateLogPath = Join-Path $BuildDirectory "bp045-049r1-view-state.log"
$TemporaryBeamReportPath = Join-Path $BuildDirectory "bp045-049r1-temporary-beams.json"
$TemporaryBeamLogPath = Join-Path $BuildDirectory "bp045-049r1-temporary-beams.log"
$ParticleRuntimeReportPath = Join-Path $BuildDirectory "bp045-049r1-particle-runtime.json"
$ParticleRuntimeLogPath = Join-Path $BuildDirectory "bp045-049r1-particle-runtime.log"
$ClientRenderClosureReportPath = Join-Path $BuildDirectory "bp045-049r1-client-render-closure.json"
$ClientRenderClosureLogPath = Join-Path $BuildDirectory "bp045-049r1-client-render-closure.log"
$WorldSurfaceRenderReportPath = Join-Path $BuildDirectory "bp045-049r1-world-surfaces.json"
$WorldSurfaceRenderLogPath = Join-Path $BuildDirectory "bp045-049r1-world-surfaces.log"
$LightmapAtlasReportPath = Join-Path $BuildDirectory "bp045-049r1-lightmap-atlas.json"
$LightmapAtlasLogPath = Join-Path $BuildDirectory "bp045-049r1-lightmap-atlas.log"
$DynamicLightRenderReportPath = Join-Path $BuildDirectory "bp045-049r1-dynamic-lights.json"
$DynamicLightRenderLogPath = Join-Path $BuildDirectory "bp045-049r1-dynamic-lights.log"
$SkyWaterRenderReportPath = Join-Path $BuildDirectory "bp045-049r1-sky-water.json"
$SkyWaterRenderLogPath = Join-Path $BuildDirectory "bp045-049r1-sky-water.log"
$WorldRenderClosureReportPath = Join-Path $BuildDirectory "bp045-049r1-world-render-closure.json"
$WorldRenderClosureLogPath = Join-Path $BuildDirectory "bp045-049r1-world-render-closure.log"
$AliasModelReportPath = Join-Path $BuildDirectory "bp045-049r1-alias-model.json"
$AliasModelLogPath = Join-Path $BuildDirectory "bp045-049r1-alias-model.log"
$SpriteSyncReportPath = Join-Path $BuildDirectory "bp045-049r1-sprite-sync.json"
$SpriteSyncLogPath = Join-Path $BuildDirectory "bp045-049r1-sprite-sync.log"
$RenderUiHudReportPath = Join-Path $BuildDirectory "bp045-049r1-render-ui-hud.json"
$RenderUiHudLogPath = Join-Path $BuildDirectory "bp045-049r1-render-ui-hud.log"
$RenderEvidenceReportPath = Join-Path $BuildDirectory "bp045-049r1-render-evidence.json"
$RenderEvidenceLogPath = Join-Path $BuildDirectory "bp045-049r1-render-evidence.log"
$ModelUiRenderReportPath = Join-Path $BuildDirectory "bp045-049r1-model-ui-render.json"
$ModelUiRenderLogPath = Join-Path $BuildDirectory "bp045-049r1-model-ui-render.log"
$EvidenceDirectory = Join-Path $BuildDirectory "bp045-049r1-evidence"
$EvidenceALogPath = Join-Path $BuildDirectory "bp045-049r1-evidence-a.log"
$EvidenceBLogPath = Join-Path $BuildDirectory "bp045-049r1-evidence-b.log"
$EvidenceComparisonPath = Join-Path $BuildDirectory "bp045-049r1-evidence-comparison.json"
$EvidenceComparisonLogPath = Join-Path $BuildDirectory "bp045-049r1-evidence-comparison.log"
$QuakeCStockLogPath = Join-Path $BuildDirectory "bp045-049r1-quakec-stock-tests.log"
$GameValidationLogPath = Join-Path $BuildDirectory "bp045-049r1-game-validation.log"
$RuntimeValidationLogPath = Join-Path $BuildDirectory "bp045-049r1-runtime-validation.log"
$BisectReportPath = Join-Path $BuildDirectory "bp045-049r1-bisect-report.json"
...
try {
  ...
  Invoke-ExternalStep -Name "render evidence comparator self-test" -Executable $PythonExe -Arguments @($PythonPrefix + @($RenderEvidenceComparator, "--self-test")) -Detail "TGA parser, exact comparison and SSIM" -LogPath (Join-Path $BuildDirectory "bp045-049r1-evidence-comparator-selftest.log")
  ...
  $IndependentGroups = @(
    [ordered]@{ package = "BASE"; name = "core tests"; exe = "MiniQuakeTests.exe"; log = "bp045-049r1-core-tests.log" },
    [ordered]@{ package = "BASE"; name = "milestone tests"; exe = "MiniQuakeMilestoneTests.exe"; log = "bp045-049r1-milestone-tests.log" },
    [ordered]@{ package = "BASE"; name = "deterministic diagnostics"; exe = "MiniQuakeCompatTraceTests.exe"; log = "bp045-049r1-diagnostics-tests.log" },
    [ordered]@{ package = "BP-010R1"; name = "Protocol 15 wire"; exe = "MiniQuakeProtocol15WireTests.exe"; log = "bp045-049r1-wire-tests.log" },
    [ordered]@{ package = "BP-011"; name = "Protocol 15 command/update"; exe = "MiniQuakeProtocol15CommandTests.exe"; log = "bp045-049r1-command-tests.log" },
    [ordered]@{ package = "BP-012R1"; name = "Protocol 15 server data"; exe = "MiniQuakeProtocol15ServerDataTests.exe"; log = "bp045-049r1-serverdata-tests.log" },
    [ordered]@{ package = "BP-013"; name = "Protocol 15 events"; exe = "MiniQuakeProtocol15EventTests.exe"; log = "bp045-049r1-event-tests.log" },
    [ordered]@{ package = "BP-014R1"; name = "Protocol 15 runtime events"; exe = "MiniQuakeProtocol15RuntimeEventTests.exe"; log = "bp045-049r1-runtime-event-tests.log" },
    [ordered]@{ package = "BP-015"; name = "signon queue and stages"; exe = "MiniQuakeProtocol15SignonTests.exe"; log = "bp045-049r1-signon-tests.log" },
    [ordered]@{ package = "BP-016"; name = "reliable delivery scheduling"; exe = "MiniQuakeProtocol15DeliveryTests.exe"; log = "bp045-049r1-delivery-tests.log" },
    [ordered]@{ package = "BP-017"; name = "datagram ACK and retransmission"; exe = "MiniQuakeProtocol15DatagramTests.exe"; log = "bp045-049r1-datagram-tests.log" },
    [ordered]@{ package = "BP-018"; name = "demo framing and playback"; exe = "MiniQuakeProtocol15DemoTests.exe"; log = "bp045-049r1-demo-tests.log" },
    [ordered]@{ package = "BP-019"; name = "cross-layer Protocol 15 closure and freeze"; exe = "MiniQuakeProtocol15ClosureTests.exe"; log = "bp045-049r1-protocol15-closure-tests.log" },
    [ordered]@{ package = "BP-020"; name = "QuakeC progs.dat ABI and CRC"; exe = "MiniQuakeQuakeCProgsTests.exe"; log = "bp045-049r1-quakec-progs-tests.log" },
    [ordered]@{ package = "BP-021"; name = "QuakeC VM byte and stack parity"; exe = "MiniQuakeQuakeCVMTests.exe"; log = "bp045-049r1-quakec-vm-tests.log" },
    [ordered]@{ package = "BP-022"; name = "QuakeC edict and save-text parity"; exe = "MiniQuakeQuakeCEdictTests.exe"; log = "bp045-049r1-quakec-edict-tests.log" },
    [ordered]@{ package = "BP-023"; name = "QuakeC builtin table and formatting"; exe = "MiniQuakeQuakeCBuiltinTests.exe"; log = "bp045-049r1-quakec-builtin-tests.log" },
    [ordered]@{ package = "BP-024"; name = "frozen QuakeC contract closure"; exe = "MiniQuakeQuakeCClosureTests.exe"; log = "bp045-049r1-quakec-closure-tests.log" },
    [ordered]@{ package = "BP-025"; name = "world hull parity"; exe = "MiniQuakeWorldHullTests.exe"; log = "bp045-049r1-world-hull-tests.log" },
    [ordered]@{ package = "BP-025"; name = "world trace parity"; exe = "MiniQuakeWorldTraceTests.exe"; log = "bp045-049r1-world-trace-tests.log" },
    [ordered]@{ package = "BP-026"; name = "world link and collision parity"; exe = "MiniQuakeWorldLinkTests.exe"; log = "bp045-049r1-world-link-tests.log" },
    [ordered]@{ package = "BP-027"; name = "monster movement parity"; exe = "MiniQuakeServerMoveTests.exe"; log = "bp045-049r1-server-move-tests.log" },
    [ordered]@{ package = "BP-028"; name = "server physics parity"; exe = "MiniQuakeServerPhysicsTests.exe"; log = "bp045-049r1-server-physics-tests.log" },
    [ordered]@{ package = "BP-028"; name = "sv_user movement parity"; exe = "MiniQuakeSvUserMovementTests.exe"; log = "bp045-049r1-sv-user-movement-tests.log" },
    [ordered]@{ package = "BP-029"; name = "server user parity"; exe = "MiniQuakeServerUserTests.exe"; log = "bp045-049r1-server-user-tests.log" },
    [ordered]@{ package = "BP-029"; name = "frozen world and physics closure"; exe = "MiniQuakeWorldPhysicsClosureTests.exe"; log = "bp045-049r1-world-physics-closure-tests.log" },
    [ordered]@{ package = "BP-030"; name = "host timing and frame clock"; exe = "MiniQuakeHostTimingTests.exe"; log = "bp045-049r1-host-timing-tests.log" },
    [ordered]@{ package = "BP-031"; name = "command buffer and cvar lifecycle"; exe = "MiniQuakeCommandCvarTests.exe"; log = "bp045-049r1-command-cvar-tests.log" },
    [ordered]@{ package = "BP-032"; name = "demo lifecycle"; exe = "MiniQuakeDemoLifecycleTests.exe"; log = "bp045-049r1-demo-lifecycle-tests.log" },
    [ordered]@{ package = "BP-033"; name = "savegame v5"; exe = "MiniQuakeSavegameV5Tests.exe"; log = "bp045-049r1-savegame-v5-tests.log" },
    [ordered]@{ package = "BP-034"; name = "host lifecycle closure"; exe = "MiniQuakeHostLifecycleClosureTests.exe"; log = "bp045-049r1-host-lifecycle-closure-tests.log" },
    [ordered]@{ package = "BP-035"; name = "client state and render handoff"; exe = "MiniQuakeClientStateRenderTests.exe"; log = "bp045-049r1-client-state-render-tests.log" },
    [ordered]@{ package = "BP-036"; name = "view state and chase camera"; exe = "MiniQuakeViewStateTests.exe"; log = "bp045-049r1-view-state-tests.log" },
    [ordered]@{ package = "BP-037"; name = "temporary beam model entities"; exe = "MiniQuakeTemporaryBeamTests.exe"; log = "bp045-049r1-temporary-beam-tests.log" },
    [ordered]@{ package = "BP-038"; name = "particle runtime parity"; exe = "MiniQuakeParticleRuntimeTests.exe"; log = "bp045-049r1-particle-runtime-tests.log" },
    [ordered]@{ package = "BP-039"; name = "frozen client/render closure"; exe = "MiniQuakeClientRenderClosureTests.exe"; log = "bp045-049r1-client-render-closure-tests.log" },
    [ordered]@{ package = "BP-040"; name = "world surfaces and texture chains"; exe = "MiniQuakeWorldSurfaceRenderTests.exe"; log = "bp045-049r1-world-surface-tests.log" },
    [ordered]@{ package = "BP-041"; name = "lightmap formats and atlas ownership"; exe = "MiniQuakeLightmapAtlasTests.exe"; log = "bp045-049r1-lightmap-atlas-tests.log" },
    [ordered]@{ package = "BP-042"; name = "dynamic-light frame and brush marking"; exe = "MiniQuakeDynamicLightRenderTests.exe"; log = "bp045-049r1-dynamic-light-render-tests.log" },
    [ordered]@{ package = "BP-043"; name = "sky and water Binary32 rendering"; exe = "MiniQuakeSkyWaterRenderTests.exe"; log = "bp045-049r1-sky-water-render-tests.log" },
    [ordered]@{ package = "BP-044"; name = "frozen world/render closure"; exe = "MiniQuakeWorldRenderClosureTests.exe"; log = "bp045-049r1-world-render-closure-tests.log" },
    [ordered]@{ package = "BP-045"; name = "alias model and shadow parity"; exe = "MiniQuakeAliasModelTests.exe"; log = "bp045-049r1-alias-model-tests.log" },
    [ordered]@{ package = "BP-046"; name = "sprite synchronization parity"; exe = "MiniQuakeSpriteSyncTests.exe"; log = "bp045-049r1-sprite-sync-tests.log" },
    [ordered]@{ package = "BP-047"; name = "2D and HUD integration parity"; exe = "MiniQuakeRenderUiHudTests.exe"; log = "bp045-049r1-render-ui-hud-tests.log" },
    [ordered]@{ package = "BP-048"; name = "deterministic render evidence"; exe = "MiniQuakeRenderEvidenceTests.exe"; log = "bp045-049r1-render-evidence-tests.log" },
    [ordered]@{ package = "BP-049"; name = "frozen model/UI/render closure"; exe = "MiniQuakeModelUiRenderClosureTests.exe"; log = "bp045-049r1-model-ui-render-closure-tests.log" }
  )
  ...
  $Summary = [ordered]@{
    ...
    artifacts = [ordered]@{
      ...
      render_evidence_directory = "bp045-049r1-evidence"
      ...
      trace_directory = "bp045-049r1-traces"
