...
function testFastEntityEncoding()
  ...
  longItem.baseline = t.EntityBaseline(1, 0, 0, 0, t.Vec3(0.0, 0.0, 0.0), t.Vec3(0.0, 0.0, 0.0))
  sz.clear(buffer)
...
function testDatagramFraming()
  ...
  second = secondResult[3]
  assertTrue(second is bytes, "ACK schedules second fragment")
