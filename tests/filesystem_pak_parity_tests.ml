...
// Exercise the bytes test scenario and verify its expected result.
...
// Build deterministic test data for root.
function inline bp071FixtureRoot()
  return "build\\bp071-filesystem"
end function
// Exercise the prepare loose test scenario and verify its expected result.
...
// Exercise the archives test scenario and verify its expected result.
