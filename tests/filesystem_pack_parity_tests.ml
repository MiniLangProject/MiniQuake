...
// Exercise the root test scenario and verify its expected result.
function inline bp071Root()
  return "build\\bp071_fs"
end function
// Exercise the game test scenario and verify its expected result.
function bp071Game()
  return qfs.join(bp071Root(), "id1")
end function
// Encode and write the requested value.
...
// Exercise the pack test scenario and verify its expected result.
...
// Exercise the prepare test scenario and verify its expected result.
