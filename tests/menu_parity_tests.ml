...
function testDrawAndKeyDispatch()
  ...
  assertEqual(scaled[0], 160.0, "original menu horizontal center")
  assertEqual(scaled[1], 0.0, "original menu top alignment")
  assertEqual(scaled[2], 1.0, "original menu pixel scale")
  highDpi = menu.layout(2048, 1152)
  assertEqual(highDpi[0], 704.0, "high-DPI menu horizontal center")
  assertEqual(highDpi[1], 376.0, "high-DPI menu vertical center")
  assertEqual(highDpi[2], 2.0, "high-DPI menu integral scale")
  menu.M_Menu_Main_f(state)
